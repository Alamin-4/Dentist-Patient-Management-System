      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3 border-b border-slate-200 pb-4">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-[#10436B] hover:bg-[#0d3656] px-4 py-2 text-xs font-bold text-white active:scale-95 transition-all cursor-pointer"
          >
