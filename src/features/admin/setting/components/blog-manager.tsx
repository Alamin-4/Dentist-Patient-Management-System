      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="border-b border-slate-200 pb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#10436B] hover:bg-[#0d3656] text-white px-4 py-2 text-xs font-bold active:scale-95 transition-all cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {posts.length === 0 ? (
            ...
            posts.map((post: BlogPost) => (
              <div
                key={post.id}
                className="group border border-slate-200 bg-white rounded-xl overflow-hidden flex flex-col transition-colors hover:border-[#10436B]/40"
              >
                {/* Cover Image */}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className={cn(
                ...
                errors.summary ? "border-red-400 focus:border-red-500" : "border-slate-200 focus:border-[#10436B]"
              )}
            />
            {errors.summary && (
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={cn(
                ...
                errors.author ? "border-red-400 focus:border-red-500" : "border-slate-200 focus:border-[#10436B]"
              )}
            />
            {errors.author && (
            ...
            <div className="relative">
              <input
                ...
                className={cn(
                  ...
                  errors.coverImage ? "border-red-400 focus:border-red-500" : "border-slate-200 focus:border-[#10436B]"
                )}
              />
