                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="mt-5 flex justify-end sm:col-span-2">
                        <button
                            type="submit"
                            disabled={updateProfileMutation.isPending}
                            className="flex items-center justify-center gap-2 rounded-lg px-5 py-2.5 text-sm font-semibold text-white bg-[#1A1A2E] hover:bg-[#1A1A2E]/90 disabled:opacity-60 disabled:cursor-not-allowed min-w-32.5 cursor-pointer"
                        >
