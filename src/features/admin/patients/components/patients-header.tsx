...
export function PatientsHeader({ headerSearch, setHeaderSearch }: Props) {
    return (
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 className="text-2xl font-bold tracking-tight text-text">Patients</h1>
            ...
            <div className="flex items-center gap-2">
                <div className="relative hidden sm:block">
                    ...
                    <input
                        ...
                        className="h-9 w-52 rounded-lg border border-gray-200 bg-white pl-9 pr-3 text-sm outline-none placeholder:text-gray-400 focus:border-text focus:ring-1 focus:ring-text"
                    />
                </div>
                ...
                <button className="flex h-9 items-center gap-2 rounded-lg bg-text px-4 text-sm font-semibold text-white hover:bg-text/90 transition-colors">
