export function MetricsPlaceholder() {
  return (
    <div className="mt-8 rounded-2xl border border-gray-100 bg-white shadow-sm h-[400px] md:h-[500px] flex flex-col items-center justify-center text-center px-6">
