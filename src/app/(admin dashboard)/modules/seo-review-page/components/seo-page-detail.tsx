    ...
    <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        {["Before", "After"].map((label) => (
          <div
            key={label}
            className="relative flex aspect-[4/3] items-center justify-center overflow-hidden rounded-xl bg-gray-100"
          >
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-5">
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            ...
            <div className="mt-5">
              ...
              <div className="rounded-xl border border-gray-100 bg-gray-50 p-4 text-sm italic leading-relaxed text-gray-700">
                &ldquo;{page.review_content}&rdquo;
              </div>
            </div>
        ...
        <div className="w-full shrink-0 lg:w-72 xl:w-80">
          <div className="rounded-xl bg-[#1A1A2E] p-5 text-white shadow-lg">
            ...
            <Link
              href={`/admin/dentists`}
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-white/10 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-white/20"
            >
