    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            readOnly
            disabled
            className="w-full h-16 px-6 rounded-xl border border-slate-200 text-lg font-medium text-slate-400 bg-slate-50 cursor-not-allowed outline-none"
          />
        </div>
      ...
      <div className="flex justify-end gap-4 pt-4">
        ...
        <button
          type="submit"
          disabled={updateProfileMutation.isPending}
          className="px-10 py-4 rounded-xl bg-[#0F3659] font-bold text-white text-xl hover:bg-[#0a2640] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center min-w-[200px]"
        >
