    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl p-0 overflow-hidden border-none rounded-3xl gap-0">
        ...
        <div className="p-8 space-y-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Before Upload */}
              <label className="cursor-pointer border-2 border-dashed border-slate-200 rounded-lg h-48 flex flex-col items-center justify-center gap-3 bg-[#F8FAFC]/30 hover:bg-slate-50 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <Select>
              <SelectTrigger className="h-16 rounded-lg border-slate-200 px-6 text-lg text-slate-400 focus:ring-[#0F3659]">
        ...
        <div className="p-8 pt-0 flex flex-col sm:flex-row gap-4">
          ...
          <Button className="flex-1 h-16 rounded-lg bg-[#0F3659] text-xl font-bold text-white hover:bg-[#0a2640]">
            Add Photo
          </Button>
        </div>
      </DialogContent>
