        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full justify-center">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-7 py-3 rounded-full bg-primary text-white font-semibold hover:opacity-90 transition-all cursor-pointer shadow-sm shadow-primary/15 w-full sm:w-auto"
            >
              <LogIn size={18} />
              <span>Sign In</span>
            </button>
